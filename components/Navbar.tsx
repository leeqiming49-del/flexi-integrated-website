  ...
  return (
    <>
      <nav className="navbar" aria-label="Primary navigation">
        <Link className="brand" href="/" aria-label="Flexi Integrated home"><BrandLogo priority /></Link>
      ...
      <aside className={`mobile-drawer ${open ? "is-open" : ""}`} id="mobile-menu" aria-hidden={!open}>
        <div className="drawer-top"><span className="brand dark-brand"><BrandLogo /></span><button className="drawer-close" type="button" aria-label="Close navigation menu" onClick={() => setOpen(false)}>×</button></div>
